...
public class ComplaintRecord extends UpdatableRecordImpl<ComplaintRecord> implements Record11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Timestamp, String> {

    private static final long serialVersionUID = 1818209198;
    ...
    /**
     * Setter for <code>webapp.complaint.start_working_date</code>.
     */
    public void setStartWorkingDate(Timestamp value) {
        set(8, value);
    }

    /**
     * Getter for <code>webapp.complaint.start_working_date</code>.
     */
    ...
    /**
     * Setter for <code>webapp.complaint.finish_date</code>.
     */
    ...
    /**
     * Getter for <code>webapp.complaint.finish_date</code>.
     */
    ...
    /**
     * Setter for <code>webapp.complaint.note</code>.
     */
    ...
    /**
     * Getter for <code>webapp.complaint.note</code>.
     */
    ...
    @Override
    public Row11<Integer, Integer, Integer, Integer, Integer, Integer, Integer, Timestamp, Timestamp, Timestamp, String> valuesRow() {
    ...
    public Field<Timestamp> field9() {
        return Complaint.COMPLAINT.START_WORKING_DATE;
    }

    @Override
    public Field<Timestamp> field10() {
        return Complaint.COMPLAINT.FINISH_DATE;
    }

    @Override
    public Field<String> field11() {
        return Complaint.COMPLAINT.NOTE;
    }
    ...
    @Override
    public ComplaintRecord value9(Timestamp value) {
        setStartWorkingDate(value);
        return this;
    }

    @Override
    public ComplaintRecord value10(Timestamp value) {
        setFinishDate(value);
        return this;
    }

    @Override
    public ComplaintRecord value11(String value) {
        setNote(value);
        return this;
    }

    @Override
    public ComplaintRecord values(Integer value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Integer value7, Timestamp value8, Timestamp value9, Timestamp value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ComplaintRecord(Integer id, Integer userId, Integer apartmentId, Integer problemId, Integer facilitiesId, Integer roomId, Integer statusNo, Timestamp createDate, Timestamp startWorkingDate, Timestamp finishDate, String note) {
        super(Complaint.COMPLAINT);
